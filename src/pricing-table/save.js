            ...
            <div className='fbs-pricing-table'>
                ...
                <div className="cards">
                    <div className="card shadow">
                        ...
                        <h2 id="basic" className="price bottom-bar">${starterPrice}</h2>
                        <RichText.Content tagName="ul" value={ attributes.basicContent } />
                        <button className="btn">Learn More</button>
                    </div>
                    <div className="card active">
                    <h3 className="pack">{premiumTitle}</h3>
                        <h2 id="basic" className="price bottom-bar">${premiumPrice}</h2>
                        <RichText.Content tagName="ul" value={ attributes.premiumContent } />
                        <button className="btn">Learn More</button>
                    </div>
                    <div className="card shadow">
                    <h3 className="pack">{businessTitle}</h3>
                        <h2 id="basic" className="price bottom-bar">${businessPrice}</h2>
